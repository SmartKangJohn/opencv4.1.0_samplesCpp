...
int main(int argc, char* argv[])
{
    ...
    CommandLineParser parser(argc, argv,
                             "{@img1 | 0_data/data/graf1.png | input image 1}"
                             "{@img2 | 0_data/data/graf3.png | input image 2}"
                             "{@homography | 0_data/data/H1to3p.xml | homography matrix}");
    ...
    imshow("0_data/AKAZE_result", res);
    waitKey();
    //! [draw final matches]
