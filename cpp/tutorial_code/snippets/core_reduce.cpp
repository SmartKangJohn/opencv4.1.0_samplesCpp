...
int main()
{
    ...
    Mat m1 = (Mat_<uchar>(4, 3) << 8, 1, 3,
        20, 9, 35,
        7, 2, 22,
        5, 40, 88);
    Mat m1_min_x, m1_min_y, m1_max_x, m1_max_y;
    reduce(m1, m1_min_x, 0, REDUCE_MIN, CV_8U);
    reduce(m1, m1_min_y, 1, REDUCE_MIN, CV_8U);
    reduce(m1, m1_max_x, 0, REDUCE_MAX, CV_8U);
    reduce(m1, m1_max_y, 1, REDUCE_MAX, CV_8U);
