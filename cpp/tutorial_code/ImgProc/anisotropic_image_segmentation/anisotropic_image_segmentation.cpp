...
int main()
{
    ...
    String fileName = "0_data\\gst_input.jpg";
...
#if 01
    Mat imgCoherency1, imgOrientation1;
    imgCoherency.convertTo(imgCoherency1, CV_8U);
    imgOrientation.convertTo(imgOrientation1, CV_8U);
#endif
...
#if 01
    Mat imgCoherency2, imgOrientation2;
    imgCoherency.convertTo(imgCoherency2, CV_8U);
    imgOrientation.convertTo(imgOrientation2, CV_8U);
#endif

    imwrite("0_data\\gst_result1.jpg", 0.5*(imgIn + imgBin));
    imwrite("0_data\\gst_Coherency1.jpg", imgCoherency);
    imwrite("0_data\\gst_Orientation1.jpg", imgOrientation);
    //! [main_extra]
    return 0;
}
//! [calcGST]
